...
printf '%s\n' \
  ...
  '' \
  '## This release: Adaptive Frame Generation, SteamOS recovery, and 2x hitch handling' \
  '' \
  ...
  '- **Profile compatibility settings:** Launcher-only options such as Base FPS Cap, WoW64, Gamescope WSI, Zink, MangoHud, and Disable Frame Generation now persist with the selected Decky profile. Existing wrapper settings are imported automatically during the upgrade.' \
