...
printf '%s\n' \
  ...
  '- **Isolation cleanup:** Removed Gamescope WSI and MangoHud controls. The isolated launcher deliberately excludes global implicit Vulkan layers, so those controls were not reliable for experimental-wrapper games.' \
